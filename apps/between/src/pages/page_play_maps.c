...
enum { eFieldKind = 0, eFieldSlot, eFieldParam, eFieldValue };
...
static s16 find_param(const char *label) { return module_find_param(label); }
...
static void redraw(void) {
  ...
  if (show_value) {
    ...
    val_lab_x =
        (PLAY_MAPS_VAL_X > val_lab_w) ? (u8)(PLAY_MAPS_VAL_X - val_lab_w) : 0;
...
static void cycle_enc_kind(PlayEncMap *m, s8 dir) {
  static const PlayEncKind seq_no_mod[] = {ePlayEncNone, ePlayEncMorphX,
                                           ePlayEncMorphY};
  static const PlayEncKind seq_mod[] = {ePlayEncNone, ePlayEncMorphX,
                                        ePlayEncMorphY, ePlayEncParamSlot,
                                        ePlayEncParamAll};
...
static void cycle_sw_kind(PlaySwMap *m, s8 dir) {
  ...
  static const PlaySwKind seq_mod[] = {
      ePlaySwNone,    ePlaySwSnapA,   ePlaySwSnapB,  ePlaySwSnapC, ePlaySwSnapD,
      ePlaySwSetSlot, ePlaySwMomSlot, ePlaySwSetAll, ePlaySwMomAll};
